...
import { View, StyleSheet, Text,TextInput, Image, Pressable, Modal } from "react-native";
import { useNavigation } from "@react-navigation/native";
import MyActivity from "../../components/MainActivity";
import { Margin, Color, FontSize, FontFamily, Border } from "../../../GlobalStyle";
      ...
      <View style={[styles.selectFromContactsNew, styles.groupIconLayout]}>
        ...
        <View style={[styles.searchContactParent, styles.searchLayout]}>
          <View style={[styles.searchContact, styles.searchLayout]}>
            ...
            />
            <TextInput placeholder="Enter Name or Number"  style={styles.enterNameOr}>Enter Name or Number</TextInput>
