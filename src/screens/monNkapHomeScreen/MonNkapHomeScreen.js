  ...
  return (
    <>
      <View style={styles.monkapHomeScreen}>
        ...
        />
        <View style={[styles.monkapHomeScreenItem, styles.monkapPosition,  {backgroundColor:'red'}]} />
        <View
          style={[
        ...
        />
        <View style={[styles.mtnMomo, styles.mtnMomoLayout,{backgroundColor:'green'}]}>
          <Image
            style={[
              styles.mtnMomoChild,
              styles.childLayout1,
        ...
        />
        <View
          style={[styles.njangi, styles.njangiLayout, styles.njangiPosition,{backgroundColor:'pink'}]}
        >
          <Image
            style={[
              styles.njangiChild,
        ...
        <View style={styles.targetSavings}>
          <View
            style={[
